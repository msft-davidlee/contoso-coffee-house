...
param blueprintName string = 'contoso-coffee-house'
// cch = contoso-coffee-house
param prefix string = 'cch'
...
var rgs = [
  {
    name: 'cch-shared-services'
    tags: {
      'stack-name': 'cch-platform'
      'stack-environment': stackEnvironment
      'stack-sub-name': 'cch-shared-services'
    }
      ...
      resources: [
        {
          ...
          location: location
          tags: {
            'stack-name': 'cch-shared-key-vault'
            'stack-environment': stackEnvironment
            'stack-sub-name': 'cch-shared-services'
          }
          properties: {
        ...
        }
        {
          ...
          location: location
          tags: {
            'stack-name': 'cch-shared-container-registry'
            'stack-environment': stackEnvironment
            'stack-sub-name': 'cch-shared-services'
          }
          sku: {
        ...
        }
        {
          ...
          location: location
          tags: {
            'stack-name': 'cch-shared-configuration'
            'stack-environment': stackEnvironment
            'stack-sub-name': 'cch-shared-services'
          }
          sku: {
